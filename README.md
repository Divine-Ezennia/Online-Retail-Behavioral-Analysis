...
|----------------------------------|-------------------------------------|
| 📄 **[Executive Report](./reports/executive/)**<br>Strategic intelligence synthesis | 💻 **[Technical Documentation](./reports/technical/)**<br>Full architecture, reproducibility & artifact governance |
| 📊 **[Executive Presentation](./reports/presentation/)**<br>Board-level behavioral intelligence narrative | 🛠️ **[Modular R Scripts](./scripts/)**<br>Deterministic analytical pipeline |
| 🖼️ **[Visualization Library](./visualizations/)**<br>All exported 300 DPI figures | 📦 **[Processed Artifact Layer](./data/processed/README.md)**<br>Artifact governance documentation |
